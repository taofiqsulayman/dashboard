...
const SideBar = () => {
  return (
    <aside
      id="logo-sidebar"
      class="hidden lg:flex lg:flex-col w-64 h-screen pt-4 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 px-8"
      aria-label="Sidebar"
    >
      <div class="flex items-center justify-start mb-10">
        <a href="#" class="">
          <img src={companyLogo} class="h-8 w-auto mr-3" alt="Open pay Logo" />
        </a>
      </div>
